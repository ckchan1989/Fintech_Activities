...
statement_one = full_name + 'is a ' + nationality + ' ' + profession + 'born in ' + str(birth_year)
print(statement_one)
...
statement_three = 'In ' + str(year_of_publish) + ' she published the first algorithm, the ' + first_algorithm + ', at the age of ' + str(age_at_passing-10)
...
statement_four = 'She was a ' + nationality + ' Citizen who live in ' + city_location + ', ' + country_location + ' until her passing in ' + str(death_year) + ' at the age of ' + str(age_at_passing)
